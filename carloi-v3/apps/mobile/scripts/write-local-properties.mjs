...
if (!sdkDir) {
  throw new Error(`Android SDK not found. Checked: ${sdkCandidates.join(', ') || 'no candidates available'}`);
}

mkdirSync(androidDir, { recursive: true });
writeFileSync(localPropertiesPath, `sdk.dir=${sdkDir.replace(/\\/g, '\\\\')}\n`, 'utf8');
console.log(`[CarloiV3][Android] wrote ${localPropertiesPath}`);
