...
if (!sourceIcon) {
  throw new Error(`Carloi icon source not found. Checked: ${sourceCandidates.join(', ')}`);
}
...
console.log(`[CarloiV3][Icon] synced ${sourceIcon} -> ${targetIcon}`);
